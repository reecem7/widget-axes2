...
cprequire_test(["inline:com-chilipeppr-widget-axes2"], function (xyz) {
    console.log("test running of " + xyz.id);
    //sp.init("192.168.1.7");
    //xyz.initAs3dPrinting();
    xyz.init();
    xyz.showBody("com-chilipeppr-widget-axes2");
    xyz.currentUnits = 'mm'
    ...
    $('#com-chilipeppr-widget-axes2').wrap(wrapDiv);
    ...
    setTimeout(function() {
        ...
        $('#com-chilipeppr-widget-axes2-ftr').keydown(function(evt) {
            var e = $.Event('keydown');
            ...
            if (e.which > 0) {
                ...
                $('#com-chilipeppr-widget-axes2-ftr').trigger(e);
                return false;
            }
        });
...
cpdefine("inline:com-chilipeppr-widget-axes2", ["chilipeppr_ready", "jquerycookie"], function () {
    return {
        id: "com-chilipeppr-widget-axes2",
        ...
        pencilSetup: function() {
            ...
            //$('#com-chilipeppr-widget-axes2-x').mouseover(this.pencilOnMouseover.bind(this));
            //$('#com-chilipeppr-widget-axes2-x').mouseout(this.pencilOnMouseout.bind(this));
            $('#com-chilipeppr-widget-axes2-x').hover(this.pencilOnMouseover.bind(this), this.pencilOnMouseout.bind(this));
            $('#com-chilipeppr-widget-axes2-y').hover(this.pencilOnMouseover.bind(this), this.pencilOnMouseout.bind(this));
            $('#com-chilipeppr-widget-axes2-z').hover(this.pencilOnMouseover.bind(this), this.pencilOnMouseout.bind(this));
            $('#com-chilipeppr-widget-axes2-a').hover(this.pencilOnMouseover.bind(this), this.pencilOnMouseout.bind(this));
        },
        ...
        initAs3dPrinting: function () {
            ...
            $('#com-chilipeppr-widget-axes2-a').removeClass("hidden");
            $('#com-chilipeppr-widget-axes2-b').removeClass("hidden");
            // change labels
            $('#com-chilipeppr-widget-axes2-a .com-chilipeppr-xyz-label').text("E0");
            $('#com-chilipeppr-widget-axes2-b .com-chilipeppr-xyz-label').text("E1");
            // change units
            $('#com-chilipeppr-widget-axes2-a .com-chilipeppr-xyz-dim').text("mm");
            $('#com-chilipeppr-widget-axes2-b .com-chilipeppr-xyz-dim').text("mm");

        },
        setupShowHideWcsBtn: function () {

            var btnEl = $("#com-chilipeppr-widget-axes2 .btnToggleShowWcs");
        ...
        toggleWcs: function (evt) {
            $("#com-chilipeppr-widget-axes2 .btnToggleShowWcs").popover('hide');
            var wcsEl = $('#com-chilipeppr-widgetholder-wcs');
            if (wcsEl.hasClass("hidden")) {
                wcsEl.removeClass("hidden");
                $('#com-chilipeppr-widget-axes2 .btnToggleShowWcs').addClass("active");
            } else {
                wcsEl.addClass("hidden");
                $('#com-chilipeppr-widget-axes2 .btnToggleShowWcs').removeClass("active");

            }
        },
        setupShowHideTouchBtn: function () {
            $("#com-chilipeppr-widget-axes2 .btnToggleShowTouchJog").popover();
        ...
        showHideTouchBtn: function () {
            ...
            var btnEl = $("#com-chilipeppr-widget-axes2 .btnShowTouchJog");
            var btnParentWidth = btnEl.parent().parent().width();
            var widgetWidth = $("#com-chilipeppr-widget-axes2").width();
        ...
        setupTouchArea: function () {
            this.canvas = $('#com-chilipeppr-widget-axes2 .touchpad-overlay canvas');
            var tpad = $('#com-chilipeppr-widget-axes2 .touchpad-overlay');
            ...
            this.canvas.prop({
                ...
                */
            this.el = $('#com-chilipeppr-widget-axes2 .touchpad-overlay canvas')[0];
            this.canvasResize();
            //this.ctx = $('#com-chilipeppr-widget-axes2 .touchpad-overlay canvas')[0].getContext("2d");
            var that = this;
            ...
            */
            ...
            $('#com-chilipeppr-widget-axes2 .btnToggleShowTouchJog').click(this.toggleTouchJog.bind(this));
        ...
        toggleTouchJog: function () {
            $('#com-chilipeppr-widget-axes2 .btnToggleShowTouchJog').popover('hide');
            var tpad = $('#com-chilipeppr-widget-axes2 .touchpad-overlay');
            if (tpad.hasClass("hidden")) {
                tpad.removeClass("hidden");
                this.canvasResize();
                $('#com-chilipeppr-widget-axes2 .btnToggleShowTouchJog').addClass("active");
            } else {
                tpad.addClass("hidden");
                $('#com-chilipeppr-widget-axes2 .btnToggleShowTouchJog').removeClass("active");
        ...
        toolbarSetup: function () {
            ...
            var that = this;
            $('#com-chilipeppr-widget-axes2 .view-small').click(function () {
                that.bodyShowSmall();
                localStorage.setItem("/" + that.id + "/size", "small");
            });
            $('#com-chilipeppr-widget-axes2 .view-large').click(function () {
                that.bodyShowNormal();
                localStorage.setItem("/" + that.id + "/size", "normal");
            });
        },
        bodyShowSmall: function () {
            $('#com-chilipeppr-widget-axes2').addClass("size-small");
            $('#com-chilipeppr-widget-axes2 .view-small').addClass("active");
            $('#com-chilipeppr-widget-axes2 .view-large').removeClass("active");
        },
        bodyShowNormal: function () {
            $('#com-chilipeppr-widget-axes2').removeClass("size-small");
            $('#com-chilipeppr-widget-axes2 .view-small').removeClass("active");
            $('#com-chilipeppr-widget-axes2 .view-large').addClass("active");
        },
        options: null,
        setupUiFromCookie: function () {
            // read vals from cookies
            var options = $.cookie('com-chilipeppr-widget-axes2-options');
        ...
        saveOptionsCookie: function () {
            ...
            // store cookie
            $.cookie('com-chilipeppr-widget-axes2-options', optionsStr, {
                expires: 365 * 10,
                path: '/'
            });
        },
        ...
        onPlannerPause: function () {
            ...
            if (this.pauseBtnIcon === null) this.pauseBtnIcon = $('#com-chilipeppr-widget-axes2 div.plannerpause');
        ...
        */
        ...
        onCoordsUpdate: function (coords) {
            ...
            if (coords.coordNum != this.lastCoords.coordNum) {
                $('.com-chilipeppr-widget-axes2-coords').text(coords.coord);
        ...
        setupAxes: function () {
            this.axisx = {
                intblack: $('#com-chilipeppr-widget-axes2-x .xyz-intblack'),
                intgray: $('#com-chilipeppr-widget-axes2-x .xyz-intgray'),
                negpos: $('#com-chilipeppr-widget-axes2-x .xyz-negpos'),
                decimal: $('#com-chilipeppr-widget-axes2-x .xyz-decimal')
            };
            this.axisy = {
                intblack: $('#com-chilipeppr-widget-axes2-y .xyz-intblack'),
                intgray: $('#com-chilipeppr-widget-axes2-y .xyz-intgray'),
                negpos: $('#com-chilipeppr-widget-axes2-y .xyz-negpos'),
                decimal: $('#com-chilipeppr-widget-axes2-y .xyz-decimal')
            };
            this.axisz = {
                intblack: $('#com-chilipeppr-widget-axes2-z .xyz-intblack'),
                intgray: $('#com-chilipeppr-widget-axes2-z .xyz-intgray'),
                negpos: $('#com-chilipeppr-widget-axes2-z .xyz-negpos'),
                decimal: $('#com-chilipeppr-widget-axes2-z .xyz-decimal')
            };
            this.axisa = {
                intblack: $('#com-chilipeppr-widget-axes2-a .xyz-intblack'),
                intgray: $('#com-chilipeppr-widget-axes2-a .xyz-intgray'),
                negpos: $('#com-chilipeppr-widget-axes2-a .xyz-negpos'),
                decimal: $('#com-chilipeppr-widget-axes2-a .xyz-decimal')
            };
            this.axismx = {
                intblack: $('#com-chilipeppr-widget-axes2-mx .xyz-intblack'),
                intgray: $('#com-chilipeppr-widget-axes2-mx .xyz-intgray'),
                negpos: $('#com-chilipeppr-widget-axes2-mx .xyz-negpos'),
                decimal: $('#com-chilipeppr-widget-axes2-mx .xyz-decimal')
            };
            this.axismy = {
                intblack: $('#com-chilipeppr-widget-axes2-my .xyz-intblack'),
                intgray: $('#com-chilipeppr-widget-axes2-my .xyz-intgray'),
                negpos: $('#com-chilipeppr-widget-axes2-my .xyz-negpos'),
                decimal: $('#com-chilipeppr-widget-axes2-my .xyz-decimal')
            };
            this.axismz = {
                intblack: $('#com-chilipeppr-widget-axes2-mz .xyz-intblack'),
                intgray: $('#com-chilipeppr-widget-axes2-mz .xyz-intgray'),
                negpos: $('#com-chilipeppr-widget-axes2-mz .xyz-negpos'),
                decimal: $('#com-chilipeppr-widget-axes2-mz .xyz-decimal')
            };
            this.axisma = {
                intblack: $('#com-chilipeppr-widget-axes2-ma .xyz-intblack'),
                intgray: $('#com-chilipeppr-widget-axes2-ma .xyz-intgray'),
                negpos: $('#com-chilipeppr-widget-axes2-ma .xyz-negpos'),
                decimal: $('#com-chilipeppr-widget-axes2-ma .xyz-decimal')
            };
            this.axes = {
                x: this.axisx,
                y: this.axisy,
        ...
        menuSetup: function () {
            $('#com-chilipeppr-widget-axes2 .xyz-showa').click(this.showHideAxisA.bind(this));
            $('#com-chilipeppr-widget-axes2 .showhideaaxis').click(this.showHideAxisA.bind(this));
            $('#com-chilipeppr-widget-axes2 .showhidemDRO').click(this.showHidemDRO.bind(this));

            // Setup zeroing G92 - per axis menu
            $('#com-chilipeppr-widget-axes2-x .dropdown-menu a').eq(0).click("x", this.zeroOutAxisG92.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-y .dropdown-menu a').eq(0).click("y", this.zeroOutAxisG92.bind(this)).prop('href', 'javascript:');;
            $('#com-chilipeppr-widget-axes2-z .dropdown-menu a').eq(0).click("z", this.zeroOutAxisG92.bind(this)).prop('href', 'javascript:');;
            $('#com-chilipeppr-widget-axes2-a .dropdown-menu a').eq(0).click("a", this.zeroOutAxisG92.bind(this)).prop('href', 'javascript:');;

            // Setup unzeroing G92 - per axis menu
            $('#com-chilipeppr-widget-axes2-x .dropdown-menu a').eq(1).click("x", this.unzeroOutAxisG92.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-y .dropdown-menu a').eq(1).click("y", this.unzeroOutAxisG92.bind(this)).prop('href', 'javascript:');;
            $('#com-chilipeppr-widget-axes2-z .dropdown-menu a').eq(1).click("z", this.unzeroOutAxisG92.bind(this)).prop('href', 'javascript:');;
            $('#com-chilipeppr-widget-axes2-a .dropdown-menu a').eq(1).click("a", this.unzeroOutAxisG92.bind(this)).prop('href', 'javascript:');;

            // Setup goto Work zero - per axis menu
            $('#com-chilipeppr-widget-axes2-x .dropdown-menu a').eq(2).click("x", this.gotoZero.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-y .dropdown-menu a').eq(2).click("y", this.gotoZero.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-z .dropdown-menu a').eq(2).click("z", this.gotoZero.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-a .dropdown-menu a').eq(2).click("a", this.gotoZero.bind(this)).prop('href', 'javascript:');

            // Setup zeroing G10 (work) - per axis menu
            $('#com-chilipeppr-widget-axes2-x .dropdown-menu a').eq(3).click("mx", this.zeroOutAxisG10.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-y .dropdown-menu a').eq(3).click("my", this.zeroOutAxisG10.bind(this)).prop('href', 'javascript:');;
            $('#com-chilipeppr-widget-axes2-z .dropdown-menu a').eq(3).click("mz", this.zeroOutAxisG10.bind(this)).prop('href', 'javascript:');;
            $('#com-chilipeppr-widget-axes2-a .dropdown-menu a').eq(3).click("ma", this.zeroOutAxisG10.bind(this)).prop('href', 'javascript:');;

            // Setup goto Machine zero - per axis menu
            $('#com-chilipeppr-widget-axes2-x .dropdown-menu a').eq(4).click("x", this.gotoZeroM.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-y .dropdown-menu a').eq(4).click("y", this.gotoZeroM.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-z .dropdown-menu a').eq(4).click("z", this.gotoZeroM.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-a .dropdown-menu a').eq(4).click("a", this.gotoZeroM.bind(this)).prop('href', 'javascript:');

            // Setup homing with no limit switches - per axis menu
            $('#com-chilipeppr-widget-axes2-x .dropdown-menu a').eq(5).click("x", this.zeroOutAxisG28.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-y .dropdown-menu a').eq(5).click("y", this.zeroOutAxisG28.bind(this)).prop('href', 'javascript:');;
            $('#com-chilipeppr-widget-axes2-z .dropdown-menu a').eq(5).click("z", this.zeroOutAxisG28.bind(this)).prop('href', 'javascript:');;
            $('#com-chilipeppr-widget-axes2-a .dropdown-menu a').eq(5).click("a", this.zeroOutAxisG28.bind(this)).prop('href', 'javascript:');;

            // Setup homing with limit switches - per axis menu
            $('#com-chilipeppr-widget-axes2-x .dropdown-menu a').eq(6).click("x", this.homeAxis.bind(this)).prop('href', 'javascript:');
            $('#com-chilipeppr-widget-axes2-y .dropdown-menu a').eq(6).click("y", this.homeAxis.bind(this)).prop('href', 'javascript:');;
            $('#com-chilipeppr-widget-axes2-z .dropdown-menu a').eq(6).click("z", this.homeAxis.bind(this)).prop('href', 'javascript:');;
            $('#com-chilipeppr-widget-axes2-a .dropdown-menu a').eq(6).click("a", this.homeAxis.bind(this)).prop('href', 'javascript:');;
        ...
        showHideAxisA: function () {
            var el = $('#com-chilipeppr-widget-axes2-a');
            if (el.hasClass('hidden')) {
                this.isAAxisShowing = true;
                el.removeClass('hidden');
                $('#com-chilipeppr-widget-axes2 .showhideaaxis').addClass("active");
            } else {
                this.isAAxisShowing = false;
                el.addClass('hidden');
                $('#com-chilipeppr-widget-axes2 .showhideaaxis').removeClass("active");
            }
            $(window).trigger('resize');
        },
        ismDROShowing: false,
        showHidemDRO: function () {
            var el = $('#com-chilipeppr-widget-axes2-mx');
            if ($('#com-chilipeppr-widget-axes2-mx').hasClass('hidden')) {
                this.ismDROShowing = true;
                $('#com-chilipeppr-widget-axes2-mx').removeClass('hidden');
                $('#com-chilipeppr-widget-axes2-my').removeClass('hidden');
                $('#com-chilipeppr-widget-axes2-mz').removeClass('hidden');
                $('#com-chilipeppr-widget-axes2 .showhidemDRO').addClass("active");
            } else {
                this.ismDROShowing = false;
                $('#com-chilipeppr-widget-axes2-mx').addClass('hidden');
                $('#com-chilipeppr-widget-axes2-my').addClass('hidden');
                $('#com-chilipeppr-widget-axes2-mz').addClass('hidden');
                $('#com-chilipeppr-widget-axes2 .showhidemDRO').removeClass("active");
            }
            $(window).trigger('resize');
        },
        btnSetup: function () {
            // setup planner indicator icon
            $('#com-chilipeppr-widget-axes2 div.plannerpause').popover({
                html: true,
                delay: 200,
                animation: true,
                trigger: 'hover',
            ...
            // in / mm
            $('#com-chilipeppr-widget-axes2 .btnInMm').click(this.toggleInMm.bind(this));

            $('#com-chilipeppr-widget-axes2 .showhidemDRO').popover();
            $('#com-chilipeppr-widget-axes2 .showhideaaxis').popover();
            $('#com-chilipeppr-widget-axes2 .btnInMm').popover();
            $('#com-chilipeppr-widget-axes2 .btnmachineDRO').popover();
        },
        jogFocusIndicate: function () {
            $('#com-chilipeppr-widget-axes2').addClass("panel-primary");
        },
        jogFocusUnindicate: function () {
            $('#com-chilipeppr-widget-axes2').removeClass("panel-primary");
        },
        ...
        customMenuSetVal: function (itemNum) {
            ...
            var inputEl = $('#com-chilipeppr-widget-axes2-ftr ' + cls);
            var val = parseFloat(inputEl.val());
            if (val != null) {
                $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomVal').text(val);
                this.changeBaseVal({
                    data: {
                        newval: val,
            ...
            } else $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomVal').text("-");
        },
        jogSetup: function () {
            // attach to focus and blur events
            // when focused, we'll jog
            var that = this;
            $('#com-chilipeppr-widget-axes2-jog').popover();
            $('#com-chilipeppr-widget-axes2-ftr .btn').popover();


            // setup button events
            $('#com-chilipeppr-widget-axes2-ftr .jogx').click("X+", this.jogBtn.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogy').click("Y+", this.jogBtn.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogz').click("Z+", this.jogBtn.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogxneg').click("X-", this.jogBtn.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogyneg').click("Y-", this.jogBtn.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogzneg').click("Z-", this.jogBtn.bind(this));

            //gotoZero
            $('#com-chilipeppr-widget-axes2-ftr .joggotozerow').click("xyz", this.gotoZero.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogzerooutw').click("xyz", this.zeroOutAxisG10.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .joghomem').click("xyz", this.homeAxis.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .joggotozerom').click("xyz", this.gotoZeroM.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogzerooutm').click("xyz", this.zeroOutAxisG28.bind(this));


            // setup base value increment buttons
            $('#com-chilipeppr-widget-axes2-ftr .jogincr1').click({
                newval: 1.0,
                cls: ".jogincr1"
            }, this.changeBaseVal.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogincrpt1').click({
                newval: 0.1,
                cls: ".jogincrpt1"
            }, this.changeBaseVal.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogincrpt01').click({
                newval: 0.01,
                cls: ".jogincrpt01"
            }, this.changeBaseVal.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogincrpt001').click({
                newval: 0.001,
                cls: ".jogincrpt001"
            }, this.changeBaseVal.bind(this));

            // setup custom increment button
            var custIncrBtn = $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomBtn');
            custIncrBtn.click(function () {
                var txt = $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomVal').text();
                if (txt != "-") {
            ...
            var custDropUpBtn = $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomDropUpBtn');
            custDropUpBtn.on('click', function () {
                console.log("drop up btn clicked");
                that.isInCustomMenu = true;
                //$('#com-chilipeppr-widget-axes2-ftr').blur();
            });

            // show/ hide.bs.dropdown
            var custMenu = $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomDropUpMenu').parent();
            ...
            var custInput = $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomInput');
            ...
            $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomSet1').click(1, this.customMenuSetVal.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomSet2').click(2, this.customMenuSetVal.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomSet3').click(3, this.customMenuSetVal.bind(this));
            $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomSet4').click(4, this.customMenuSetVal.bind(this));

            // setup jog btn
            $('#com-chilipeppr-widget-axes2-jog').click(function () {
                console.log("setting focus/blur to footer");
                var elFtr = $('#com-chilipeppr-widget-axes2-ftr');
                //if ($('#com-chilipeppr-widget-axes2').hasClass('panel-primary'))
                //    elFtr.blur();
                //else
                elFtr.focus();
            });
            ...
            $('#com-chilipeppr-widget-axes2-ftr').focusin(function () {
                ...
                $('#com-chilipeppr-widget-axes2').addClass("panel-primary");
                $('#com-chilipeppr-widget-axes2-ftr').addClass("panel-primary");
                isjogging = true;
                that.accelBaseValHilite({});
                console.log("got focusin on axes widget ftr");
            });
            $('#com-chilipeppr-widget-axes2-ftr').focusout(function () {

                //console.log("jog area blur");
                $('#com-chilipeppr-widget-axes2').removeClass("panel-primary");
                $('#com-chilipeppr-widget-axes2-ftr').removeClass("panel-primary");
                isjogging = false;
                that.accelBaseValHilite({});
                console.log("got focusout on axes widget ftr");
            });
            /*$('#com-chilipeppr-widget-axes2-ftr').keypress(function (evt) {
            ...
            $('#com-chilipeppr-widget-axes2-ftr').keydown(function (evt) {
                ...
                */
                ...
                if (key == 38) {
                    // up arrow. Y+
                    direction = "Y+";
                    $('#com-chilipeppr-widget-axes2-ftr .jogy').addClass("hilite");
                } else if (key == 40) {
                    // down arrow. Y-
                    direction = "Y-";
                    $('#com-chilipeppr-widget-axes2-ftr .jogyneg').addClass("hilite");
                } else if (key == 37) {
                    direction = "X-";
                    $('#com-chilipeppr-widget-axes2-ftr .jogxneg').addClass("hilite");
                } else if (key == 39) {
                    direction = "X+";
                    $('#com-chilipeppr-widget-axes2-ftr .jogx').addClass("hilite");
                } else if (key == 33) {
                    // page up
                    direction = "Z+";
                    $('#com-chilipeppr-widget-axes2-ftr .jogz').addClass("hilite");
                } else if (key == 34) {
                    // page down
                    direction = "Z-";
                    $('#com-chilipeppr-widget-axes2-ftr .jogzneg').addClass("hilite");
                }
            ...
            $('#com-chilipeppr-widget-axes2-ftr').keyup(function (evt) {
                ...
                if (key == 38) {
                    // up arrow. Y+
                    $('#com-chilipeppr-widget-axes2-ftr .jogy').removeClass("hilite");
                } else if (key == 40) {
                    // down arrow. Y-
                    $('#com-chilipeppr-widget-axes2-ftr .jogyneg').removeClass("hilite");
                } else if (key == 37) {
                    $('#com-chilipeppr-widget-axes2-ftr .jogxneg').removeClass("hilite");
                } else if (key == 39) {
                    $('#com-chilipeppr-widget-axes2-ftr .jogx').removeClass("hilite");
                } else if (key == 33) {
                    // page up
                    $('#com-chilipeppr-widget-axes2-ftr .jogz').removeClass("hilite");
                } else if (key == 34) {
                    // page down
                    $('#com-chilipeppr-widget-axes2-ftr .jogzneg').removeClass("hilite");
                }
        ...
        accelBaseValHilite: function (evt) {
            ...
            $('#com-chilipeppr-widget-axes2-ftr .jogincrements-horiz button').removeClass("hiliteblue");

            if (isCustom) {
                // just tweak the val in red <code> instead of hiliting button
                $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomBtn').addClass("hiliteblue");
                this.customOrigVal = this.baseval;
                $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomVal').text(accelval);
            } else {
                this.customOrigVal = null;
                //$('#com-chilipeppr-widget-axes2-ftr .btnincrements button').removeClass("hiliteblue");
                if (accelval == 1.0) $('#com-chilipeppr-widget-axes2-ftr .jogincr1').addClass("hiliteblue");
                if (accelval == 0.1) $('#com-chilipeppr-widget-axes2-ftr .jogincrpt1').addClass("hiliteblue");
                if (accelval == 0.01) $('#com-chilipeppr-widget-axes2-ftr .jogincrpt01').addClass("hiliteblue");
                if (accelval == 0.001) $('#com-chilipeppr-widget-axes2-ftr .jogincrpt001').addClass("hiliteblue");
            }
        },
        accelBaseValUnhilite: function () {
            ...
            if (this.customOrigVal != null) {
                ...
                this.customOrigVal = null;
                $('#com-chilipeppr-widget-axes2-ftr .jogincrCustomVal').text(this.baseval);
            }
        ...
        changeBaseVal: function (evt) {
            ...
            this.accelBaseval = this.baseval;
            // reset all hilites
            $('#com-chilipeppr-widget-axes2-ftr .jogincrements-horiz button').removeClass("hilite");
            $('#com-chilipeppr-widget-axes2-ftr .jogincrements-horiz button').removeClass("hiliteblue");
            //$('#com-chilipeppr-widget-axes2-ftr .btnincrements button').removeClass("hilite");
            // set new hilite
            $('#com-chilipeppr-widget-axes2-ftr ' + evt.data.cls).addClass("hilite");
        ...
        forkSetup: function () {
            //$('#com-chilipeppr-widget-axes2-tbar-fork').prop('href', this.fiddleurl);
            //$('#com-chilipeppr-widget-axes2-tbar-standalone').prop('href', this.url);
            //$('#com-chilipeppr-widget-axes2 .fork-name').html(this.id);
            $('#com-chilipeppr-widget-axes2 .panel-title').popover({
                title: this.name,
                content: this.desc,
                trigger: 'hover',
                placement: "auto",
            ...
            chilipeppr.load("http://fiddle.jshell.net/chilipeppr/zMbL9/show/light/", function () {
                require(['inline:com-chilipeppr-elem-pubsubviewer'], function (pubsubviewer) {
                    pubsubviewer.attachTo($('#com-chilipeppr-widget-axes2 .panel-heading .dropdown-menu'), that);
                });
            });
